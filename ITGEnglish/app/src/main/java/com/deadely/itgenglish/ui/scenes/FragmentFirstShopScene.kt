...
@AndroidEntryPoint
class FragmentFirstShopScene : BaseFragment(R.layout.fragment_first_shop_scene) {
    val viewModel: FragmentFirstShopSceneViewModel by viewModels()
    ...
    private fun openConditionScene() {
        val intent = Intent(activity, ConditionActivity::class.java).apply {
            ...
            putExtra(IMAGE, R.drawable.shop_condition)
            putExtra(MESSAGE, getString(R.string.dialog_city_shop_condition_start))
