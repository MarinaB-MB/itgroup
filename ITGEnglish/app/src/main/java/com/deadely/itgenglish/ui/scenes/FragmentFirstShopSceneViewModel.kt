...
class FragmentFirstShopSceneViewModel @ViewModelInject constructor(
    ...
    private val data = listOf<Text>(
        Text(true, "Excuse me. Where can i find peanut butter?"),
        Text(false, "Peanut butter stands next to the vegetable section."),
        Text(true, "Thank you very much."),
